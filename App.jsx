    ...
    <div style={{ fontFamily:"'Outfit',sans-serif", background:"#FDFAF6", color:"#1C1410", minHeight:"100vh" }}>
      ...
      <section style={{ padding:"72px clamp(20px,5vw,60px)", maxWidth:1200, margin:"0 auto" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(170px,1fr))", gap:18 }}>
          {[{c:"Bangkok",img:"https://images.unsplash.com/photo-1508009603885-50cf7c579365?w=700&q=85",n:"8,200+"},{c:"Phuket",img:"https://images.unsplash.com/photo-1544550581-5f7ceaf7f992?w=700&q=85",n:"3,400+"},{c:"Chiang Mai",img:"https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=700&q=85",n:"2,100+"},{c:"Pattaya",img:"https://images.unsplash.com/photo-1563245372-f21724e3856d?w=700&q=85",n:"1,800+"},{c:"Hua Hin",img:"https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?w=700&q=85",n:"900+"},{c:"Koh Samui",img:"https://images.unsplash.com/photo-1537956965359-7573183d1f57?w=700&q=85",n:"600+"}].map((x,i)=>(
            <div key={i} onClick={()=>{ setCity(x.c); document.getElementById("buy")?.scrollIntoView({behavior:"smooth"}); }} style={{ position:"relative", borderRadius:18, overflow:"hidden", cursor:"pointer", aspectRatio:"4/5", border:city===x.c?"2px solid #C9A96E":"2px solid transparent", boxShadow:city===x.c?"0 12px 32px rgba(201,169,110,0.35)":"0 6px 20px rgba(0,0,0,0.12)", transition:"all 0.35s cubic-bezier(0.22,1,0.36,1)" }}
              ...
              <img src={x.img} alt={x.c} style={{ width:"100%", height:"100%", objectFit:"cover", transition:"transform 0.55s cubic-bezier(0.22,1,0.36,1)" }}/>
              <div style={{ position:"absolute", inset:0, background:"linear-gradient(to top,rgba(20,12,6,0.88) 0%,rgba(20,12,6,0.25) 45%,rgba(201,169,110,0.12) 100%)" }}/>
